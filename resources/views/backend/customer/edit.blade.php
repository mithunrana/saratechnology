...
@section('maincontent')
  ...
  <section id="vueapp" class="content">
    <div class="container-fluid">
        <form action="{{route('dashboard.customer.update',$CustomerObj->id)}}" method="POST">
            @csrf
            <div class="row">
                <div class="col-sm-9">
                    <div class="card card-primary">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control {{$errors->has('name') ? ' is-invalid' : ''}}" id="name" name="name" value="{{$CustomerObj->name}}" placeholder="Name">
                                @if ($errors->has('name'))
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" oninput="this.value=this.value.toLowerCase()" class="form-control {{$errors->has('email') ? ' is-invalid' : ''}}" value="{{$CustomerObj->email}}" id="email" name="email" placeholder="Email">
                                @if ($errors->has('color'))
                            ...
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="checkbox" name="change_password" class="form-check-input"> Change password?
                                </label>
                            </div>
