      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-4">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item">
              <a href="{{route('dashboard.customer.add')}}" class="btn btn-info"> ADD NEW &nbsp<i class="fa fa-plus" aria-hidden="true"></i></a>
            </li>
          </ol>
        </div>
      </div>
                        ...
                        <tbody>
                            @foreach($GetCustomer as $Customer)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('dashboard.customer.edit',$Customer->id) }}" class="btn btn-info" data-toggle="tooltip" title="Edit"><i class="fa fa-edit" style="font-size: 17px;"></i></a>
