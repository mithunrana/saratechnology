                ...
                <div class="card card-primary">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control  {{$errors->has('description') ? ' is-invalid' : ''}}" id="description" name="description" rows="4"  placeholder="Enter ...">{{$BlogData->description}}</textarea>
                        </div>
            ...
            <div class="col-sm-3">
                ...
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        ...
                        <input type="text" oninput="this.value=this.value.toLowerCase()" class="form-control {{$errors->has('order') ? ' is-invalid' : ''}}" id="order" name="order" value="{{$BlogData->order}}" placeholder="order">
                        @if ($errors->has('order'))
