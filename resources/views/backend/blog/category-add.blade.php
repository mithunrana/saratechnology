...
@section('maincontent')
  ...
  <section id="vueapp" class="content">
    <div class="container-fluid">
      <form action="{{route('dashboard.blog.category.store')}}" method="POST">
        @csrf
        <div class="row">
          <div class="col-sm-9">
            <div class="card card-primary">
              <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{$errors->has('content') ? ' is-invalid' : ''}} summernote-editor" rows="3" id="content" name="content" value="" placeholder="content">{{old('content')}}</textarea>
                </div>

                <div class="form-group">
                  <label for="icon">Icon</label>
                  <input type="text" class="form-control {{$errors->has('icon') ? ' is-invalid' : ''}}" id="icon"  value="{{old('icon')}}" name="icon" placeholder="Ex: fa fa-home">
                </div>
              </div>
            </div>
