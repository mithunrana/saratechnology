...
@section('maincontent')
            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item active">Taxes add</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section id="vueapp" class="content">
        <div class="container-fluid">
            <form action="{{route('dashboard.product.taxes.store')}}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-sm-9">
                        <div class="card card-primary">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control {{$errors->has('percentage') ? ' is-invalid' : ''}}" id="percentage" name="percentage" value="{{old('percentage')}}" placeholder="percentage %">
