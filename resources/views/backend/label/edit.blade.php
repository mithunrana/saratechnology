...
@section('maincontent')
  ...
  <section id="vueapp" class="content">
    <div class="container-fluid">
        <form action="{{route('dashboard.product.label.update',$GetLabelData->id)}}" method="POST">
            @csrf
            <div class="row">
                <div class="col-sm-9">
                    <div class="card card-primary">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control {{$errors->has('name') ? ' is-invalid' : ''}}" id="name" name="name" value="{{$GetLabelData->name}}" placeholder="Name">
                                @if ($errors->has('name'))
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" oninput="this.value=this.value.toLowerCase()" class="form-control {{$errors->has('color') ? ' is-invalid' : ''}}" value="{{$GetLabelData->color}}" id="color" name="color" placeholder="color">
                                @if ($errors->has('color'))
