                ...
                <div class="row">
                        ...
                        <div class="card card-primary">
                            <div class="card-body">
                                ...
                                @if (count($Product->productVariation) > 0)
                                    <div class="card card-default">
                                        <div class="card-header">
                                            <h3 class="card-title" style="color:#1f64a0!important;font-weight:bold">
                                                Product has variations</h3>
                                            <span class="float-sm-right"
                                                style="color:#1f64a0!important;margin-left: 15px;"> Generate all
                                                variations</span>
                                            <span class="float-sm-right" style="color:#1f64a0!important;">Edit
                                                attribute</span>
                                        </div>
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        @foreach ($Product->attributeSet as $AttributeSet)
                                                            <th style="padding-left: 10px;">{{ $AttributeSet->title }}
                                                            </th>
                                                        @endforeach
                                                ...
                                                <tbody>
                                                    @foreach ($Product->productVariation as $Variation)
                                                        ...
                                                        <div class="modal fade" id="exampleModal_{{ $Variation->id }}" tabindex="-1"
                                                            ...
                                                            <div class="modal-dialog modal-lg" role="document">
                                                                <div class="modal-content border-0">
                                                                    <div
                                                                        class="modal-header bg-info text-light border-none">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <select
                                                                                                ...
                                                                                                @foreach ($AttributeSet->attribute as $Attribute)
                                                                                                    <option
                                                                                                        value="{{ $Attribute->id }}"
                                                                                                        @foreach ($Variation->attribute as $kwd) {{ $kwd->pivot->product_attribute_id == $Attribute->id ? 'selected' : '' }} @endforeach>
                                                                                                        {{ $Attribute->title }}
                                                                                                    </option>
                                                                                                @endforeach
                                                                                            </select>
                                                                                ...
                                                                                <div class="col">
                                                                                    <div
                                                                                        ...
                                                                                        <input type="checkbox"
                                                                                            ...
                                                                                            id="customCheck1" />
                                                                                        <label class="custom-control-label"
                                                                                            for="customCheck1">Allow check
                                                                                            out when Out of stock</label>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <hr />
                                                        ...
                                                        <tr id="removevariation{{ $Variation->id }}">
                                                            ...
                                                            <td>
                                                                <img src="http://localhost:8085/uploads/bd6124943b176f3e6555d96fb2881f5d.jpg"
                                                                    width="50" alt="Image">
                                                            </td>
                                                            ...
                                                            <td>200.00</td>
                                                            <td style="">
                                                                <input style="margin-left: 18px;height: 18px;width: 18px;"
                                                                    class="form-check-input defaultvalueradio"
                                                                    type="radio" radiobuttonvalue="1" name="is_default"
                                                                    checked="">
                                                            </td>
                                                            <td>
                                                                ...
                                                                <a href="" onclick="return ConfirmDelete();"
                                                                    ...
                                                                    title="Delete"><i aria-hidden="true"
                                        ...
                                        <!-- attribute add modal -->
                                        <div class="modal fade" id="AttributeAddModal" tabindex="-1" role="dialog"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input class="form-control discount_start_date"
                                                                            name="discount_start_date" type="text"
                                                                            id="" />
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input class="form-control discount_end_date"
                                                                            type="text" name="discount_end_date"
                                                                            id="" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="col">
                                                                    <div class="custom-control custom-checkbox">
                                                                        <input type="checkbox"
                                                                            ...
                                                                            class="custom-control-input"
                                                                            id="withstorehousemanage" />
                                                                        <label class="custom-control-label"
                                                                            for="withstorehousemanage">With Storehouse
                                                                            Management</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col">
                                                                    <div class="custom-control custom-checkbox">
                                                                        <input type="checkbox"
                                                                            class="custom-control-input"
                                                                            id="allowcheckoutstockout"
                                                                            name="allow_checkout_when_out_of_stock" />
                                                                        <label class="custom-control-label"
                                                                            for="allowcheckoutstockout">Allow check out
                                                                ...
                                                                <div class="col">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select
                                                                            ...
                                                                            name="stock_status" id="stock_status">
                                                                            <option value="in_stock"
                                                                                @if (old('status') == 'in_stock') {{ 'selected' }} @endif>
                                                                                In stock</option>
                                                                            <option value="out_of_stock"
                                                                                @if (old('status') == 'out_of_stock') {{ 'selected' }} @endif>
                                                                                Out of stock</option>
                                                                            <option value="on_backorder"
                                                                                @if (old('status') == 'on_backorder') {{ 'selected' }} @endif>
                                                                                On backorder</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                    ...
                    <div class="col-sm-3">
                        <div class="card card-default">
                            ...
                            <div class="card-body">
                                <button type="submit" value="save" class="btn btn-info"><i class="fa fa-save"></i>
                                    Save</button>
                                <button type="submit" value="apply" class="btn btn-success"><i
                                        class="fa fa-check-circle"></i> Save & Edit</button>
                            </div>
                        </div>
                                    ...
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" name="collection[]"
                                                value="{{ $Collection->id }}"
                                                {{ in_array($Collection->id, $ProductCollections) ? 'checked' : '' }}>{{ $Collection->name }}
                                        </label>
                                    </div>
                                @endforeach
                            </div>
                                ...
                                <div class="form-group">
                                    <select class="form-control {{ $errors->has('tax_id') ? ' is-invalid' : '' }}"
                                        ...
                                        @foreach ($GetAllProductTaxes as $Tax)
                                            <option value="{{ $Tax->id }}"
                                                @if ($Tax->id == $Product->tax_id) selected @endif>{{ $Tax->title }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
