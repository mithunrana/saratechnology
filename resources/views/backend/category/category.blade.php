      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-4">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item">
              <a href="{{route('dashboard.product.category.add')}}" class="btn btn-info"> ADD NEW &nbsp<i class="fa fa-plus" aria-hidden="true"></i></a>
            </li>
          </ol>
        </div>
      </div>
      ...
      <div class="card card-info">
        ...
        <form class="form-horizontal">
          <div class="card-body">
            ...
            <tbody>
              @foreach($GetAllProductCategory as $ProductCategory)
                <tr>
                  ...
                  <td>
                    @if($ProductCategory->is_featured == 1)
                      YES
                    @else
                      NO
                    @endif
                  ...
                  <td>
                    <span class="badge badge-info">{{$ProductCategory->status}}</span>
                  </td>
                  <td>
                    <a href="{{ route('dashboard.product.category.edit',$ProductCategory->id) }}" class="btn btn-info" data-toggle="tooltip" title="Edit"><i class="fa fa-edit" style="font-size: 17px;"></i></a>
