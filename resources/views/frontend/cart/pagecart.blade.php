                    ...
                    <table class="table">
                        <tbody>
                            <tr>
                                ...
                                <td class="cart_total_amount">{{Session::get('Currency')->symbol}}{{Cart::subtotal()}}</td>
                            </tr>
                            <tr>
                                <td class="cart_total_label">VAT</td>
                                <td class="cart_total_amount">{{Session::get('Currency')->symbol}}{{Cart::tax()}}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="cart_total_amount">{{Session::get('Currency')->symbol}}{{Cart::discount()}}</td>
                            </tr>
                            <tr>
                                <td class="cart_total_label">Total</td>
                                <td class="cart_total_amount"><strong>{{Session::get('Currency')->symbol}}{{Cart::total()}}</strong></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
