                                        ...
                                        <ul class="mega-menu d-lg-flex">
                                            ...
                                            <li class="mega-menu-col col-lg-5">
                                                <div class="header-banner2">
                                                    <img src="frontend/assets/images/menu_banner7.jpg" alt="menu_banner">
                                                ...
                                                <div class="header-banner2">
                                                    <img src="frontend/assets/images/menu_banner8.jpg" alt="menu_banner">
                                                    <div class="banne_info">
                                                        <h6>15% Off</h6>
                                                        <h4>Top Laptops</h4>
                                                        <a href="#">Shop now</a>
                                ...
                                <li class="dropdown dropdown-mega-menu">
                                    ...
                                    <div class="dropdown-menu">
                                        <ul class="mega-menu d-lg-flex">
                                            ...
                                            <li class="mega-menu-col col-lg-5">
                                                <div class="header-banner2">
                                                    <a href="#"><img src="frontend/assets/images/menu_banner6.jpg" alt="menu_banner"></a>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <li class="dropdown dropdown-mega-menu">
                                    ...
                                    <div class="dropdown-menu">
                                        <ul class="mega-menu d-lg-flex">
                                            ...
                                            <li class="mega-menu-col col-lg-5">
                                                <div class="header-banner2">
                                                    <a href="#"><img src="frontend/assets/images/menu_banner9.jpg" alt="menu_banner"></a>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                        ...
                                        <div class="d-lg-flex menu_banners">
                                                ...
                                                <div class="header-banner">
                                                    <div class="sale-banner">
                                                        <a class="hover_effect1" href="#">
                                                            <img src="frontend/assets/images/shop_banner_img7.jpg" alt="shop_banner_img7">
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="header-banner">
                                                    <div class="sale-banner">
                                                        <a class="hover_effect1" href="#">
                                                            <img src="frontend/assets/images/shop_banner_img8.jpg" alt="shop_banner_img8">
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="header_banner_content">
                                                        <div class="shop_banner">
                                                            <div class="banner_img overlay_bg_40">
                                                                <img src="frontend/assets/images/shop_banner3.jpg" alt="shop_banner"/>
                                                            </div> 
            	...
            	<div class="banner_section shop_el_slider">
                    <div id="carouselExampleControls" class="carousel slide carousel-fade light_arrow" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active background_bg" data-img-src="frontend/assets/images/banner13.jpg">
                            ...
                            <div class="carousel-item background_bg" data-img-src="frontend/assets/images/banner14.jpg">
                                <div class="banner_slide_content banner_content_inner">
                            ...
                            <div class="carousel-item background_bg" data-img-src="frontend/assets/images/banner15.jpg">
                                <div class="banner_slide_content banner_content_inner">
                                    <div class="col-lg-8 col-10">
                                        <div class="banner_content3 overflow-hidden">
            ...
            <div class="col-lg-2 d-none d-lg-block">
            	...
            	<div class="shop_banner2 el_banner1">
                	<a href="#" class="hover_effect1">
                        ...
                        <div class="el_img">
                			<img src="frontend/assets/images/shop_banner_img6.png" alt="shop_banner_img6">
                        </div>
                    </a>
                </div>
                ...
                <div class="shop_banner2 el_banner2">
                	<a href="#" class="hover_effect1">
                        ...
                        <div class="el_img">
                			<img src="frontend/assets/images/shop_banner_img7.png" alt="shop_banner_img7">
                        </div>
                    </a>
                </div>
                                ...
                                <div class="product_slider carousel_slider owl-carousel owl-theme dot_style1" data-loop="true" data-margin="20" data-responsive='{"0":{"items": "1"}, "481":{"items": "2"}, "768":{"items": "3"}, "991":{"items": "4"}}'>
                                    ...
                                    <div class="item">
                                        <div class="product_wrap">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="frontend/assets/images/el_img2.jpg" alt="el_img2">
                                                    <img class="product_hover_img" src="frontend/assets/images/el_hover_img2.jpg" alt="el_hover_img2">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                                        <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                                    ...
                                    <div class="item">
                                        <div class="product_wrap">
                                            ...
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="frontend/assets/images/el_img3.jpg" alt="el_img3">
                                                    <img class="product_hover_img" src="frontend/assets/images/el_hover_img3.jpg" alt="el_hover_img3">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                                        <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                                    ...
                                    <div class="item">
                                        <div class="product_wrap">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="frontend/assets/images/el_img4.jpg" alt="el_img4">
                                                    <img class="product_hover_img" src="frontend/assets/images/el_hover_img4.jpg" alt="el_hover_img4">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                                        <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                                    ...
                                    <div class="item">
                                        <div class="product_wrap">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="frontend/assets/images/el_img5.jpg" alt="el_img5">
                                                    <img class="product_hover_img" src="frontend/assets/images/el_hover_img5.jpg" alt="el_hover_img5">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                                        <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                                    ...
                                    <div class="item">
                                        <div class="product_wrap">
                                            ...
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="frontend/assets/images/el_img6.jpg" alt="el_img6">
                                                    <img class="product_hover_img" src="frontend/assets/images/el_hover_img6.jpg" alt="el_hover_img6">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                                        <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                                ...
                                <div class="product_slider carousel_slider owl-carousel owl-theme dot_style1" data-loop="true" data-margin="20" data-responsive='{"0":{"items": "1"}, "481":{"items": "2"}, "768":{"items": "3"}, "991":{"items": "4"}}'>
                                    <div class="item">
                                        <div class="product_wrap">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="frontend/assets/images/el_img7.jpg" alt="el_img7">
                                                    <img class="product_hover_img" src="frontend/assets/images/el_hover_img7.jpg" alt="el_hover_img7">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                                        <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                                    ...
                                    <div class="item">
                                        <div class="product_wrap">
                                            ...
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="frontend/assets/images/el_img8.jpg" alt="el_img8">
                                                    <img class="product_hover_img" src="frontend/assets/images/el_hover_img8.jpg" alt="el_hover_img8">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                                        <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                                    ...
                                    <div class="item">
                                        <div class="product_wrap">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="frontend/assets/images/el_img9.jpg" alt="el_img9">
                                                    <img class="product_hover_img" src="frontend/assets/images/el_hover_img9.jpg" alt="el_hover_img9">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                                        <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                                    ...
                                    <div class="item">
                                        <div class="product_wrap">
                                            ...
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="frontend/assets/images/el_img10.jpg" alt="el_img10">
                                                    <img class="product_hover_img" src="frontend/assets/images/el_hover_img10.jpg" alt="el_hover_img10">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                                        <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                                    ...
                                    <div class="item">
                                        <div class="product_wrap">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="frontend/assets/images/el_img11.jpg" alt="el_img11">
                                                    <img class="product_hover_img" src="frontend/assets/images/el_hover_img11.jpg" alt="el_hover_img11">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                                        <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                                    ...
                                    <div class="item">
                                        <div class="product_wrap">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="frontend/assets/images/el_img12.jpg" alt="el_img12">
                                                    <img class="product_hover_img" src="frontend/assets/images/el_hover_img12.jpg" alt="el_hover_img12">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                                        <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
	...
	<div class="custom-container">
    	<div class="row">
            ...
            <div class="col-md-4">
            	<div class="sale-banner mb-3 mb-md-4">
                	<a class="hover_effect1" href="#">
                		<img src="frontend/assets/images/shop_banner_img9.jpg" alt="shop_banner_img9">
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="row">
        	<div class="col-12">
            	<div class="client_logo carousel_slider owl-carousel owl-theme nav_style3" data-dots="false" data-nav="true" data-margin="30" data-loop="true" data-autoplay="true" data-responsive='{"0":{"items": "2"}, "480":{"items": "3"}, "767":{"items": "4"}, "991":{"items": "5"}, "1199":{"items": "6"}}'>
                	<div class="item">
                    	<div class="cl_logo">
                        	<img src="frontend/assets/images/cl_logo1.png" alt="cl_logo"/>
                        </div>
                    </div>
                    <div class="item">
                        <div class="cl_logo">
                        	<img src="frontend/assets/images/cl_logo2.png" alt="cl_logo"/>
                        </div>
                    </div>
                    <div class="item">
                        <div class="cl_logo">
                        	<img src="frontend/assets/images/cl_logo3.png" alt="cl_logo"/>
                        </div>
                    </div>
                    <div class="item">
                        <div class="cl_logo">
                        	<img src="frontend/assets/images/cl_logo4.png" alt="cl_logo"/>
                        </div>
                    </div>
                    <div class="item">
                        <div class="cl_logo">
                        	<img src="frontend/assets/images/cl_logo5.png" alt="cl_logo"/>
                        </div>
                    </div>
                    <div class="item">
                        <div class="cl_logo">
                        	<img src="frontend/assets/images/cl_logo6.png" alt="cl_logo"/>
                        </div>
                    </div>
                    <div class="item">
                        <div class="cl_logo">
                        	<img src="frontend/assets/images/cl_logo7.png" alt="cl_logo"/>
                        </div>
                    </div>
                </div>
            </div>
