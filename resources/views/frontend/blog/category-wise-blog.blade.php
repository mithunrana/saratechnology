...
@section('main-content')
            ...
            <div class="row">
                <div class="col-md-12">
                    <ol class="breadcrumb justify-content-md-start">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('category.blog',$CategoryData->permalink)}}">{{$CategoryData->name}}</a></li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <!-- CATEGORY CONTENT START SECTION --> 
    <div class="section">
        <div class="custom-container">
            <div class="row">
                <div class="col-12">
            ...
            <div class="row">
                <div class="col-lg-9">
                    <div class="row grid_container masonry">
                        ...
                        @foreach($CategoryData->blogs as $Blog)
